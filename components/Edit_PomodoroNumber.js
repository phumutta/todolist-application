...
export default class Edit_PomodoroNumber extends Component {
  onPressBack(){
        ...
        <View style={{flex:1,flexDirection:'column',backgroundColor:'#F6F6F6'}} >
          ...
          <TouchableOpacity  style={{flex:0.08,flexDirection:'row',marginTop:20,backgroundColor:'#ffffff', alignItems:'center'}}>
            ...
            <TouchableOpacity  style={{flex:0.1,flexDirection:'column',marginTop:20,backgroundColor:'#F6F6F6', alignItems:'center'}}>
                  <View style={{flexDirection: 'column'}} >
                    <Text style={{fontSize:18,color:'#0000000',marginLeft:10,marginEnd:3,alignItems:'center',justifyContent:'center'}}>1</Text>
                    <Text style={{fontSize:15,color:'#A2A2A2',marginLeft:10,marginEnd:3,alignItems:'center',justifyContent:'center'}}>2</Text>
                    <Text style={{fontSize:12,color:'#D4D4D4',marginLeft:11,marginEnd:3,alignItems:'center',justifyContent:'center'}}>3</Text>
                  </View>
